...
public class AppManager {
    ...
    /**
     * 是否是最顶层的activity
     * Is it the top-level activity
     *
     * @param c the activity class
     */
    public boolean isTopActivity(Class c) {
        Activity activity = currentActivity();
        if (c != null && activity != null) {
            return c.getName().equals(activity.getClass().getName());
        }
        return false;
    }
     ...
     *
     * @param cls the class of activity
     */
