...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    private void scrollToCurrentTab() {
        ...
        View child = mTabsContainer.getChildAt(mCurrentTab);
        if (child != null) {
            int offset = (int) (mCurrentPositionOffset * child.getWidth());
        /*
    ...
    private void calcIndicatorRect() {
        ...
        if (currentTabView != null) {
            ...
            if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
                TextView tvTab = currentTabView.findViewById(R.id.tv_tab_title);
                mTextPaint.setTextSize(mTextSize);
                float textWidth = mTextPaint.measureText(tvTab.getText().toString());
